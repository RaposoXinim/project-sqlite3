...
botão = ttk.Button()
aluno = ttk.Button(menu_central,text="Aluno",command = Aluno)
aluno.place(relx=0.3,rely=0.6)
professor = ttk.Button(menu_central,text="Professor",command=0)
professor.place(relx=0.45,rely=0.6)
aulas = ttk.Button(menu_central,text="Aulas",command=0)
